...
**Outgoing signing** (`fediverse_sign_request`):
...
**Incoming verification** (`fediverse_verify_signature`):
...
- The check runs in `fediverse_inbox_endpoint` after signature verification and before activity dispatch
